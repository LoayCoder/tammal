// Pure functions for the Three-Layer Intelligence Synthesis Engine
// No raw data crosses between check-in and survey pipelines.
...
export function computeCheckinPulse(
  ...
  // Participation stability (CV of daily counts)
  ...
  // Energy trend: last 7 vs previous 7
...
export function computeSurveyStructural(
  ...
  // Category health score (weighted average by response count)
  ...
  return {
    categoryHealthScore,
    lowestCategory,
    participationQuality: surveyResponseRate,
    riskCategoryCount,
  };
}
...
export function detectDivergencePatterns(
  ...
  // Rule 1: Sentiment-Structure Misalignment
  ...
  // Rule 3: Surface Positivity Risk
