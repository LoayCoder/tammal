    ...
    <div className="w-full max-w-7xl mx-auto px-6 lg:px-12">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/[0.1] bg-white/[0.04] text-[11px] text-white/50 tracking-wide uppercase">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-white text-[#0A0E1A] font-semibold text-sm hover:bg-white/90 transition-all duration-300"
            >
            ...
            <a
              href="#showcase"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-white/[0.12] text-white/70 font-medium text-sm hover:bg-white/[0.06] transition-all duration-300"
            >
              Explore Platform
            </a>
          </div>
