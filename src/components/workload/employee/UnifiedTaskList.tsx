...
import { MoreHorizontal, Pencil, Trash2, ExternalLink, GripVertical } from 'lucide-react';
...
export function UnifiedTaskList({ tasks, onEdit, onDelete, onToggle }: UnifiedTaskListProps) {
