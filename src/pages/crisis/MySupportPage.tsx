          ...
          <CardContent className="py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">{t(`crisisSupport.intents.${c.intent}`, c.intent)}</p>
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h2 className="font-semibold">{t(`crisisSupport.intents.${caseData.intent}`, caseData.intent)}</h2>
