...
import { useDivisions, type Division, type DivisionInput } from '@/hooks/useDivisions';
import { useWorkSites, type WorkSite, type WorkSiteInput } from '@/hooks/useWorkSites';
