...
import { parseUserAgent, getLocationInfo } from '@/shared/utils/deviceInfo';
export type { DeviceInfo, LocationInfo } from '@/shared/utils/deviceInfo';

// Re-export parseUserAgent for backward compatibility
export { parseUserAgent, getLocationInfo };

// getLocationInfo is now imported from @/shared/utils/deviceInfo
