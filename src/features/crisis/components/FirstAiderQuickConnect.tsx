...
import { useFirstAiders, useCrisisCases } from '@/features/crisis/hooks/crisis/useCrisisSupport';
...
import EnhancedChatPanel from '@/features/crisis/components/EnhancedChatPanel';
