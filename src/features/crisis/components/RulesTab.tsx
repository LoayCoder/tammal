...
import { useRiskMappings, useCreateRiskMapping, useUpdateRiskMapping, useDeleteRiskMapping, type RiskMapping } from '@/features/crisis/hooks/crisis/useRiskMappings';
