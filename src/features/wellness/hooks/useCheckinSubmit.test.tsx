...
vi.mock('@/features/wellness/services/checkinService', () => ({
...
import type { CheckinParams } from '@/features/wellness/services/checkinService';
...
describe('useCheckinSubmit', () => {
  ...
  it('shows info toast and skips invalidation when DuplicateCheckinError thrown', async () => {
    const { DuplicateCheckinError } = await import('@/shared/utils/errors');
