...
import { useResults } from '@/features/recognition/hooks/recognition/useResults';
import { useAppeals } from '@/features/recognition/hooks/recognition/useAppeals';
import { useAwardThemes } from '@/features/recognition/hooks/recognition/useAwardThemes';
import { FairnessReport } from '@/features/recognition/components/FairnessReport';
import { RankingsTable } from '@/features/recognition/components/RankingsTable';
import { WinnerAnnouncement } from '@/features/recognition/components/WinnerAnnouncement';
import { AppealForm } from '@/features/recognition/components/AppealForm';
import { useQuery } from '@tanstack/react-query';
import { format } from 'date-fns';
import { useNomineeNames } from '../hooks/useRecognitionQueries';
...
export default function RecognitionResults() {
  ...
  const { data: nomineeNames = {} } = useNomineeNames(nominationIds);
