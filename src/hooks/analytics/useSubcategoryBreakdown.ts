// ── useSubcategoryBreakdown — granular React Query hook ──
// Wraps fetchCategoryAnalysis for subcategory-level scores.
...
export function useSubcategoryBreakdown(
  ...
  return useQuery({
    queryKey: [
      'analytics', tenantId, 'subcategory',
